    ...
    <div>
      ...
      <section className="px-6 md:px-12 py-20 max-w-3xl mx-auto text-center">
        <p className="text-lg md:text-xl leading-relaxed text-stone-600">
          Melissa Hume creates functional and sculptural ceramic work shaped
          by texture, material, and the quiet rhythms of the studio. Each
          piece is hand-built and finished with close attention to surface
          and form.
        </p>
      </section>
